  ...
  return (
    <div>
      <div className="w-auto p-10 grid justify-center gap-5 items-center align-middle text-white">
        ...
        <div className="bg-gradient-to-r flex justify-center items-center gap-2 from-purple-50 to-blue-300 hover:to-purple-50 hover:from-blue-300 text-black py-4 w-96 hover:scale-105 hover:shadow-white rounded-full text-center text-lg font-black">
        ...
        <div className="bg-gradient-to-r flex justify-center items-center gap-2 from-purple-50 to-blue-300 hover:to-purple-50 hover:from-blue-300 text-black py-4 w-96 hover:scale-105 rounded-full text-center text-lg font-black">
